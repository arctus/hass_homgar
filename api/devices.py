...
class WeatherStation(HomgarHubDevice):
    MODEL_CODES = [257]
    FRIENDLY_DESC = "WI-FI Controlled Weather Station"
...
class TemperatureAirSensor(HomgarSubDevice):
    MODEL_CODES = [86]
    FRIENDLY_DESC = "Temperature and Humidity Sensor"
